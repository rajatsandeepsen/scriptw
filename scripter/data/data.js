export const data  =[{
    ...
    name: 'file1',
    title: 'ScriptW (beta)',
    description: `Script Writer<br>In-Browser Jupyter Notebook Alternative for JavaScript.<br>Browser only, No Node.js, No Notebook Kernels, No Server required.<br><br>
